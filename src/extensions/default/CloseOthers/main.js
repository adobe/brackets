...
define(function (require, exports, module) {
    ...
    if(settings.close_below === "true") {
        CommandManager.register("Close Others Below", "file.close_below", function () { handleClose("close_below") });
    ...
    if(settings.close_above === "true") {
        CommandManager.register("Close Others Above", "file.close_above", function () { handleClose("close_above") });
