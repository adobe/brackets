...
define({
    ...
    "CMD_COMMENT"                         : "تعویض خط نظر",
    "CMD_BLOCK_COMMENT"                   : "تعویض قالب نظر",
    ...
    "CMD_TOGGLE_LINE_NUMBERS"             : "شماره سطرها/خط ها",
    "CMD_TOGGLE_ACTIVE_LINE"              : "نشانه گذاری خط/سطر فعال",
    "CMD_TOGGLE_WORD_WRAP"                : "شکستن کلمات",
    ...
    "CMD_SHOW_IN_TREE"                    : "نمایش در پرونده درختی",
    ...
    "CLOSE_DONT_SAVE"                      : "بستن(بدون ذخیرهسازی)",
    "RELAUNCH_CHROME"                      : "اجرای دوباره Chrome",
    "ABOUT"                                : "پیرامون",
    "CLOSE"                                : "بستن",
    "ABOUT_TEXT_LINE1"                     : "sprint {VERSION_MINOR} {BUILD_TYPE} {VERSION}",
    "ABOUT_TEXT_LINE3"                     : "<div style='direction:rtl;margin-right:3px;'>یادداشتهای ها، شرایط و ضوابط مربوط به نرم افزار شخص ثالث در آدرس<a href='#' class='clickable-link' data-href='http://www.adobe.com/go/thirdparty/'>http://www.adobe.com/go/thirdparty/</a> جهت تلفیق و بعنوان مرجع قرار داده شده.",
    "ABOUT_TEXT_LINE4"                     : "اسناد و منابع نرم افزار در پیوند <a href='#' class='clickable-link' data-href='https://github.com/adobe/brackets/'>https://github.com/adobe/brackets/</a> در دسترس می باشد. <br><span style='float:left'>ترجمه توسط: محمد یعقوبی<br>info@pgrammer.com</span><br>",
    ...
    "CMD_NEW_BRACKETS_WINDOW"                   : "پنجره براکتس جدید",
