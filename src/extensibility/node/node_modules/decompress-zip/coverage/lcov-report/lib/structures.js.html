...
<html lang="en">
<head>
    <title>Code coverage report for lib/structures.js</title>
    <meta charset="utf-8">
...
<div class="header high">
    <h1>Code coverage report for <span class="entity">lib/structures.js</span></h1>
    <h2>
        
        Statements: <span class="metric">90.29% <small>(93 / 103)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Branches: <span class="metric">65% <small>(26 / 40)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Functions: <span class="metric">81.82% <small>(9 / 11)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
        
        Lines: <span class="metric">90.29% <small>(93 / 103)</small></span> &nbsp;&nbsp;&nbsp;&nbsp;
        
    </h2>
    <div class="path"><a href="../index.html">All files</a> &#187; <a href="index.html">lib/</a> &#187; structures.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-yes">2106</span>
<span class="cline-any cline-yes">2106</span>
<span class="cline-any cline-yes">2106</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2106</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2106</span>
<span class="cline-any cline-yes">33696</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2106</span>
<span class="cline-any cline-yes">2106</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">2106</span>
<span class="cline-any cline-yes">4212</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">4212</span>
<span class="cline-any cline-yes">2106</span>
<span class="cline-any cline-yes">2106</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">3261</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">3261</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
&nbsp;
        while (directory.length &lt; count) {
            <span class="missing-if-branch" title="else path not taken"" >E</span>if (stage === 'main') {
...
&nbsp;
            <span class="missing-if-branch" title="else path not taken"" >E</span>if (stage === 'fileName') {
                <span class="missing-if-branch" title="else path not taken"" >E</span>if (current.fileNameLength &gt; 0) {
                    chunk = stream.read(current.fileNameLength);
                    <span class="missing-if-branch" title="if path not taken"" >I</span>if (chunk === null) {
...
&nbsp;
            <span class="missing-if-branch" title="else path not taken"" >E</span>if (stage === 'extraField') {
...
&nbsp;
            <span class="missing-if-branch" title="else path not taken"" >E</span>if (stage === 'fileComment') {
                <span class="missing-if-branch" title="if path not taken"" >I</span>if (current.fileCommentLength &gt; 0) {
<span class="cstat-no" title="statement not covered" >                    chunk = stream.read(current.fileCommentLength);</span>
<span class="cstat-no" title="statement not covered" >                    if (chunk === null) {</span>
<span class="cstat-no" title="statement not covered" >                        return;</span>
                    }
<span class="cstat-no" title="statement not covered" >                    current.fileComment = chunk.toString();</span>
                }
&nbsp;
...
&nbsp;
    stream.on('error', <span class="fstat-no" title="function not covered" >function (err) {</span>
...
&nbsp;
        if (stage === 'fileName') {
            <span class="missing-if-branch" title="else path not taken"" >E</span>if (data.fileNameLength &gt; 0) {
...
<div class="footer">
    <div class="meta">Generated by <a href="http://istanbul-js.org/" target="_blank">istanbul</a> at Tue Sep 17 2013 13:57:27 GMT+0100 (BST)</div>
</div>
