// winfswatch.cpp : Defines the exported functions for the DLL application.
//
...
namespace node_winfsevents
{
    ...
    class NodeWinFSEvents : node::ObjectWrap
    {
    public:
        ...
        static void Initialize(v8::Handle<v8::Object> target)
        {
            ...
            Local<FunctionTemplate> t = FunctionTemplate::New(NodeWinFSEvents::New);
            constructor_template = Persistent<FunctionTemplate>::New(t);
            constructor_template->InstanceTemplate()->SetInternalFieldCount(1);
            constructor_template->SetClassName(String::NewSymbol("WinFSEvents"));
            ...
            target->Set(String::NewSymbol("WinFSEvents"), constructor);
        }

        static v8::Handle<v8::Value> Shutdown(const v8::Arguments& args)
        {
            HandleScope scope;
            NodeWinFSEvents *native = node::ObjectWrap::Unwrap<NodeWinFSEvents>(args.This());
            native->Shutdown();
            return Undefined();
        }
        ...
        static v8::Handle<v8::Value> New(const v8::Arguments& args)
        {
            ...
            NodeWinFSEvents *nativeobj = new NodeWinFSEvents(*pathname);
            nativeobj->Wrap(args.Holder());
            NODE_SET_METHOD(args.Holder(), "stop", NodeWinFSEvents::Shutdown);
            return args.This();
        }


        NodeWinFSEvents(const char *path) : ObjectWrap()
        {
/*
            running=1;
            first = NULL;
            ...
            uv_async_init(uv_default_loop(), &watcher, NodeWinFSEvents::Callback);
            watcher.data = this;
            pthread_create(&thread, NULL, &NodeWinFSEvents::Run, this);
*/
        }
...
*/
        ...
        {
/*
            NodeWinFSEvents *This = (NodeWinFSEvents *)data;
            ...
            FSEventStreamRef stream = FSEventStreamCreate(NULL, &NodeWinFSEvents::Event, &context, pathsToWatch, kFSEventStreamEventIdSinceNow, (CFAbsoluteTime) 0.1, kFSEventStreamCreateFlagNone | kFSEventStreamCreateFlagWatchRoot | kFSEventStreamCreateFlagFileEvents);
...
/*
        ...
        {
            NodeWinFSEvents *This = static_cast<NodeWinFSEvents*>(userData);
...
/*
        ...
        {
            NodeWinFSEvents *This = static_cast<NodeWinFSEvents*>(handle->data);
            HandleScope scope;
            TryCatch try_catch;
...
*/
    ...
    extern "C" void NODE_EXTERN init(v8::Handle<v8::Object> target) {
        node_winfsevents::NodeWinFSEvents::Initialize(target);
    }
}

NODE_MODULE(winfswatch, node_winfsevents::init)